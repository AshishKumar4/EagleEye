...
# NOTE: This file has been inspired from the openface project.
...
class AlignDlibFast:
    ...
    def align_and_crop(self, rgbImg, margin=10, bb=None,
              landmarks=None, skipMulti=False, scale=1.0):
        frame = self.align(rgbImg, bb, landmarks, skipMulti, scale)
        bb = self.getLargestFaceBoundingBox(rgbImg, skipMulti)
        box = face_utils.rect_to_bb(bb)
        (x, y, p, q) = box
